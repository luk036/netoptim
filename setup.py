...
# -*- coding: utf-8 -*-
"""
Setup script for netoptim

You can install netoptim with
...
if sys.version_info[:2] < (2, 7):
    print("netoptim requires Python 2.7 or later (%d.%d detected)." %
          sys.version_info[:2])
    sys.exit(-1)

# Write the version information.
sys.path.insert(0, 'netoptim')
import release
...
# docdirbase = 'share/doc/netoptim-%s' % version
...
install_requires = ['decorator>=4.1.0', 'numpy>=1.12.0', 'networkx>=2.1']
